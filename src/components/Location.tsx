        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-5">
          ...
          <div className="flex flex-col gap-5 lg:col-span-2">
            <div className="card flex items-start gap-3 p-5">
              <PinIcon className="mt-0.5 size-5 shrink-0 text-terracotta-dark" />
              <div>
                ...
                <a
                  ...
                  className="focus-ring mt-2 inline-flex items-center gap-1.5 text-sm font-semibold text-terracotta-dark hover:underline"
                >
            ...
            <div className="card p-5">
              <div className="flex items-start gap-3">
                <ClockIcon className="mt-0.5 size-5 shrink-0 text-terracotta-dark" />
